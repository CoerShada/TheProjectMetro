...
public class SyncEquipPantsMessage extends AbstractClientMessage<SyncEquipPantsMessage> {

	private int playerID;
	private int equipID;

	public SyncEquipPantsMessage() {

	}

	public SyncEquipPantsMessage(int playerID, int equipID) {
	...
	public void process(EntityPlayer player, Side side) {
		...
		//else itemStack = null;
		ExtendedPlayer.get((EntityPlayer) playerToUpd).inventory.inventory[CustomSlots.PANTS.ordinal()] = itemStack;
	}
