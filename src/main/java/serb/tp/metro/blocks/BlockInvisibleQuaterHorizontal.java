...
public class BlockInvisibleQuaterHorizontal extends BlockInvisible{
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess block, int x, int y, int z)
    {
        ...
        else if (meta == 2) setBlockBounds(0.0F, 0.0F, 0.0F, 0.5F, 0.5F, 1.0F);
        else if (meta == 4) setBlockBounds(0.0F, 0.0F, 0.0F, 1.0F, 0.5F, 0.5F);
        else if (meta == 6) setBlockBounds(0.5F, 0.0F, 0.0F, 1.0F, 0.5F, 1.0F);
        else if (meta == 1) setBlockBounds(0.0F, 0.5F, 0.5F, 1.0F, 1.0F, 1.0F);
        else if (meta == 3) setBlockBounds(0.0F, 0.5F, 0.0F, 0.5F, 1.0F, 1.0F);
        else if (meta == 5) setBlockBounds(0.0F, 0.6F, 0.0F, 1.0F, 1.0F, 0.5F);
