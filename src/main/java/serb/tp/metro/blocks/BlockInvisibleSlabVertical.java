...
public class BlockInvisibleSlabVertical extends BlockInvisible{
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess block, int x, int y, int z)
    {
        ...
        if 	(meta == 0) 	setBlockBounds(0.0F, 0.0F, 0.5F, 1.0F, 1.0F, 1.0F);
        else if (meta == 1) setBlockBounds(0.0F, 0.0F, 0.0F, 0.5F, 1.0F, 1.0F);
        else if (meta == 2) setBlockBounds(0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 0.5F);
        else 				setBlockBounds(0.5F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F);
