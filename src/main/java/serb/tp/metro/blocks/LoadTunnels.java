...
import serb.tp.metro.client.render.tiles.RenderTileTunnelLine;
...
public class LoadTunnels {
	...
	tunnel1line = new BlockTunnel(Material.rock, "tunnel1line", TileEntityTunnelLine.class),
	tunnel1line_exit_right = new BlockTunnel(Material.rock, "tunnel1line_exit_right", TileEntityTunnelLineExitRight.class), 
	//tunnel1line_exit_left = new BlockTunnelLineExitLeft(Material.rock, "tunnel1line_exit_left", TileEntityTunnelLineExitLeft.class), 
	tunnel1turn_right = new BlockTunnel(Material.rock, "tunnel1turn_right", TileEntityTunnelTurnRight.class),
	tunnel1turn_left = new BlockTunnel(Material.rock, "tunnel1turn_left", TileEntityTunnelTurnLeft.class);
	...
	public static void renderBlocks() {
		...
		ClientRegistry.bindTileEntitySpecialRenderer(TileEntityTunnelLine.class, new RenderTileTunnelLine(new ResourceLocation(Main.modid, "models/static/buildings/tunnels/tunnel1line.obj")));
		ClientRegistry.bindTileEntitySpecialRenderer(TileEntityTunnelLineExitRight.class, new RenderTileTunnelLine(new ResourceLocation(Main.modid, "models/static/buildings/tunnels/tunnel1Teh.obj"), -0.001F, 0.016F, 0.005F));
