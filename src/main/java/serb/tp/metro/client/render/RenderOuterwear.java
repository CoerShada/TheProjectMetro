...
public class RenderOuterwear {

	public RenderOuterwear() {

	}

	public void render(EntityPlayer player, RenderPlayer renderModel) {
		ItemStack equipStack = ExtendedPlayer.get(player).inventory.getStackInSlot(CustomSlots.OUTERWEAR.ordinal());
