...
public class RenderTileSpawnerGunSafeVert4 extends TileEntitySpecialRenderer {

	private int list;
	ResourceLocation texture =  new ResourceLocation(Main.modid, "textures/models/items/armor/backpack_gekkon.png");
	
    public RenderTileSpawnerGunSafeVert4(ResourceLocation res)
    {
        IModelCustom model;
        model = AdvancedModelLoader.loadModel(res);
        // = new ModelWrapperDisplayList((WavefrontObject) model);
